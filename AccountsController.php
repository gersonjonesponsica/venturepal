						...
						$investor_db->getInvestorIdByEmail($_POST['email']);
							...
							if($result){
								...
								$message = "					
									...
									<br /><br />
									<a href='http://venturepal.gccataraja.com/venturepal/biz/confirmation.php?id=$id&code=$code'>Click HERE to Activate :)</a>
									<br /><br />
									Thanks,";
			...
			$id = $accounts_db->getUserIDbyEmail($_POST['email']);
			 if(count($id) == 1){
				...
				$message= "
				   ...
				   <br />
						<a href='http://venturepal.gccataraja.com/venturepal/biz/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
				   <br />
