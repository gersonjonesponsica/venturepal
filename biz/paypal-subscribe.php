...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('business', 'venturpal@gmail.com');
   ...
   case 'success':      // Order was successful...
      ...
      $result = $a->addSubscription($_POST);
      if ($result){
        header('location: msme-portfolio?id='.$_POST['item_name'].'&action=success');
      }else{
        header('location: msme-portfolio?id='.$_POST['item_name'].'&action=error');
      }
