<?php
  ...
  if (isset($_SESSION['msme_id']) && (!empty($_SESSION['msme_id']))) {
    $msme_id = $_SESSION['msme_id'];
  }

?>
<link href="css/searchnava9.css" rel="stylesheet">
...
<script src="script/locatormap3.js"></script>
...
<input type="text" id="msme_id" hidden />
<div class="container m-t-60">
  <div class="row p-15 bg-color-F7FAFA b-r-5">
    <div class="col-lg-3">
    </div>
    <div class="col-lg-6">
      <div class="email" id="searchForm">
        <form>
          <input type="text" class="inputText" id="entrepsearch" 
                     value="" placeholder="Search Entreprenuer" /> 
        </form>
      </div>
...
<div class="container setupnav" style="left: 0; right: 0;">
  <div id="myTopnav">
    <a href='javascript:;' onclick="scrollen(this)" id="basics" id="basics" class="bat nav-active">Company Info</a>
          ...
          <div class="col-lg-10">
              <div class="container">
                ...
                <div class="row p-15 bg-color-F7FAFA m-t-10 m-b-10 b-r-5">
                  <div class="col-lg-6">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <select  id="categories" name="categories" class="form-control custom-select" style="height: 25px !important">
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="row">
                      ...
                      <div class="col-lg-8">
                        <select  id="badge" name="badge" class="form-control custom-select" style="height: 25px !important">
                ...
                <div class="row p-15 bg-color-F7FAFA m-t-10 m-b-10 b-r-5">
                  ...
                  <div class="col-lg-3">
                    <select  id="city" name="city" onchange="getAddress()" class="form-control custom-select" disabled style="height: 25px !important">
                    </select>
                  </div>
                  <div class="col-lg-1">
                ...
                <div class="row p-15 bg-color-F7FAFA m-t-10 m-b-10 b-r-5">
                  ...
                  <div class="col-lg-9">
                    ...
                    <form class="b-documents" id="bDocuments" name="bDocuments" enctype="multipart/form-data">
                      <input type='file' name="file[]" id="b_documents" value="Upload File" accept="application/pdf, image/*" multiple="multiple" hidden> 
                    </form>
...
<div class="modal fade " id="myModal" role="dialog" >
    <div class="modal-dialog  ">
        <!-- Modal content-->
        <div class="modal-content modal-lg" style="width: 1000px !important">
...
<script src="script/register-msmea2.js"></script> 
